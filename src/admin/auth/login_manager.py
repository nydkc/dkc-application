# Note that we don't use flask-login in admin/ for admin users to avoid any
# overlap with that of the DKC application users
# Instead OAuth is used, with admin users being added directly to the IAM
# permissions on the project in the Google Cloud console.
