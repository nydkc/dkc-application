...
def test_edit_profile_after_submission(client, login, mock_user):
...
def test_edit_personal_statement_after_submission(client, login, mock_user):
    mock_user.application.get.return_value.submit_time = MagicMock()

    response = client.post(
        "/application/personal-statement",
        data={"personal-statement": "New essay"},
        follow_redirects=True,
    )
...
def test_edit_projects_after_submission(client, login, mock_user):
    mock_user.application.get.return_value.submit_time = MagicMock()

    response = client.post(
        "/application/projects",
        data={"international-projects-section": "Service"},
        follow_redirects=True,
    )
...
def test_edit_involvement_after_submission(client, login, mock_user):
    mock_user.application.get.return_value.submit_time = MagicMock()

    response = client.post(
        "/application/involvement",
        data={"positions": "New Position"},
        follow_redirects=True,
    )
...
def test_edit_activities_after_submission(client, login, mock_user):
    mock_user.application.get.return_value.submit_time = MagicMock()

    response = client.post(
        "/application/activities",
        data={"advocacy-cause": "New Cause"},
        follow_redirects=True,
    )
...
def test_edit_other_after_submission(client, login, mock_user):
    mock_user.application.get.return_value.submit_time = MagicMock()

    response = client.post(
        "/application/other",
        data={"outstanding-awards": "New Award"},
        follow_redirects=True,
    )
